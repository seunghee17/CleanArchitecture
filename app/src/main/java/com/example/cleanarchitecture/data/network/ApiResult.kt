...
internal fun ApiResult<*>.throwOnSuccess(){
    if(this is ApiResult.Success) throw java.lang.IllegalStateException("error")
}
inline fun <T> ApiResult<T>.onFilure(action: (error: ApiResult.Failure) -> Unit): ApiResult<T> {
